...
RUN GOOS=linux GOARCH=amd64 go build \
    --tags "release" \
    -ldflags="-w -s -X 'github.com/bytebase/cli/cmd/version.version=${VERSION}' -X 'github.com/bytebase/cli/cmd/version.goversion=${GO_VERSION}' -X 'github.com/bytebase/cli/cmd/version.gitcommit=${GIT_COMMIT}' -X 'github.com/bytebase/cli/cmd/version.buildtime=${BUILD_TIME}' -X 'github.com/bytebase/cli/cmd/version.builduser=${BUILD_USER}'" \
    -o bb \
